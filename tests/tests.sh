...
LD_LIBRARY_PATH=./build/lib.linux-x86_64-cpython-312/KunQuant/runner/:${LD_LIBRARY_PATH} ./build/temp.linux-x86_64-cpython-312/KunCApiTest ./build/lib.linux-x86_64-cpython-312/KunQuant/runner/libKunTest.so /tmp/alpha101_stream/alpha101_stream.so
